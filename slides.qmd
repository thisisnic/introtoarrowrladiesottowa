...
<!-- 
Some of the more interesting content about what arrow is and how it works, but let's keep this super light
-->

## Demo on NYC taxi dataset

<!-- 
Give a highlight demo using the taxi dataset - show it's huge, show what we can do, but end with pointing out that we don't need 153Gb datasets to benefit and even "just" 9Gb is enough, to transition to the next section.
-->
...
<!-- Add some data manipulation content here:
* use head() to preview large dataset manipulations
* lazy eval, queries and using collect() to pull into memory
